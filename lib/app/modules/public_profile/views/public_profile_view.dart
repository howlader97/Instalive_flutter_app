                ...
                child: Column(
                  ...
                  children: [
                    if (controller.selectedTab.value == "All") ...[
                      ...
                      if (user['gender'] != null)
                        _buildInfoRow(user['gender'].toString()),

                      if (user['age'] != null)
                        _buildInfoRow("${user['age']} years old"),

                      if (user['country'] != null)
                        _buildInfoRow(user['country'].toString()),

                      if (user['friends_count'] != null)
                        _buildInfoRow("${user['friends_count']} Friends"),
