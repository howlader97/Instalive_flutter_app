...
import 'package:instalive/app/routes/app_pages.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            InkWell(
              onTap: (){
                Get.toNamed(Routes.PUBLIC_PROFILE,arguments: controller.receiverId);
              },
              child: CircleAvatar(
                radius: 20,
                ...
                backgroundImage: controller.receiverImage != null
                    ? NetworkImage(
                        AuthService.getFullUrl(controller.receiverImage),
                      )
                    : null,
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (msg.repliedToId != null) {
                    try {
                      repliedMsg = controller.messages.firstWhere(
                        (m) => m.id == msg.repliedToId,
                      );
                    } catch (_) {}
                  }
                          ...
                          children: [
                            Container(
                              margin: const EdgeInsets.symmetric(vertical: 4)
                                  .copyWith(
                                    bottom: msg.reactions.isNotEmpty ? 15 : 4,
                                  ),
                              padding: const EdgeInsets.symmetric(
                                horizontal: 16,
                                vertical: 12,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  msg.senderId == controller.receiverId
                      ? controller.receiverName
                      : "You",
                  style: const TextStyle(
                    color: AppColors.secondaryPrimary,
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  color: Colors
                      .transparent, // Or a send button color if visible in screenshot? Looks like just an icon
                ),
                child: const Icon(
                  Icons.send,
                  color: AppColors.secondaryPrimary,
