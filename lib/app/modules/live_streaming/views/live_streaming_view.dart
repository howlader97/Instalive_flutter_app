...
class LiveStreamingView extends GetView<LiveStreamingController> {
  final ActiveUsersController userController = Get.find<ActiveUsersController>();
   LiveStreamingView({super.key});
                ...
                return Stack(
                  ...
                  children: [
                    if (controller.currentUser.value?.coverImage != null)
                      Image.network(
                        AuthService.getFullUrl(
                          controller.currentUser.value!.coverImage!,
                        ),
                        fit: BoxFit.cover,
                      ),
                    BackdropFilter(
                  ...
                  child: Obx(() {
                    return Column(
                      ...
                      children: [
                        ...
                        // VIEWER view
                        else if (controller.isStreamEnded.value)
                          Column(
                            children: const [
                              Icon(
                                Icons.stop_circle,
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              UserModel host = UserModel(
                                                ...
                                                firstName: controller.hostFullName.value,
                                                profileImage: controller.hostProfileImage.value,
                                                shady: 0.0,
                                                email: 'host@example.com', // required field
                                              );
                                              _showUserOptions(context, host);
                                            },
                                            child: CircleAvatar(
                                              radius: 14,
                              ...
                              children: [
                                Expanded(
                                  child: Obx(() {
                                    ...
                                    bool isLocked =
                                        controller.isStreamEnded.value ||
                                        (!controller.isHost &&
                                            premium &&
                                            !paid);
                                    return TextField(
                                      ...
                                      readOnly: isLocked,
                                      // onTap: isLocked
                                      //     ? controller.payEntryFee
                                      //     : null,
                                      onTap: controller.isStreamEnded.value
                                          ? null
                                          : isLocked
                                          ? controller.payEntryFee
                                          : null,
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: controller.isStreamEnded.value
                                            ? "Chat Close"
                                            : isLocked
                                            ? "Unlock to chat"
                                            : "Say hi...",
                                      ...
                                      // onSubmitted: isLocked
                                      //     ? (_) {}
                                      //     : (_) => controller.sendComment(),
                                      onSubmitted: controller.isStreamEnded.value
                                          ? null
                                          : isLocked
                                          ? null
                                          : (_) => controller.sendComment(),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Get.back();
                userController.startChat(user); // ActiveUsersController method reuse
              },
            ),
            ListTile(
